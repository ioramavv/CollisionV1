...
// als uitgelogd (localStorage, met "woody" als uiteindelijke standaard, ook
// op de laad-/inlog-/aankomstpagina e.d., zodat niemands scherm verandert
// totdat ze zelf een ander thema kiezen).
import { createContext, useCallback, useContext, useEffect, useMemo, useState } from "react";
import { supabase } from "@/lib/supabaseClient";

export const SUPPORTED_THEMES = ["dark", "woody", "light"];
export const DEFAULT_THEME = "woody";
