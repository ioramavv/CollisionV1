...
export default function Board({ board, selected, slideAnim, interactive, onCellClick, highlight, labelTopLeft, labelBottomRight, moveTargets, pendingTool }) {
  return (
    <div
      style={{
        position: "relative",
              ...
              >
                ...
                {isPendingTool && (
                  <div className="pending-tool-pulse" style={{
                    ...
                    background: pendingTool.owner === "A" ? "var(--walnut)" : "var(--maple)",
