...
export function PieceGradients() {
  return (
...
export function Pawn({ owner }) {
  ...
  return (
    <svg viewBox="0 0 100 145" style={{ width: "100%", height: "auto", display: "block" }} aria-hidden="true">
      <ellipse cx="50" cy="138" rx="27" ry="6" fill="rgba(0,0,0,0.4)" />
...
function ToolPiece({ owner }) {
  ...
  return (
    <svg viewBox="0 0 100 74" style={{ width: "100%", height: "auto", display: "block" }} aria-hidden="true">
      <ellipse cx="50" cy="70" rx="35" ry="6" fill="rgba(0,0,0,0.38)" />
      <path
        ...
        strokeWidth="2.4"
      />
      <path d="M17.5,18 Q50,23 82.5,18" fill="none" stroke="rgba(0,0,0,0.2)" strokeWidth="1" />
    </svg>
  );
}
      ...
      >
        ...
        >
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderRight: "1.5px solid rgba(74, 50, 34, 0.34)",
                    borderBottom: "1.5px solid rgba(74, 50, 34, 0.34)",
                    display: "flex",
                    alignItems: "flex-end",
                ...
                >
                  ...
                  {isPendingTool && (
                    <div className="pending-tool-pulse" style={{ width: "84%", alignSelf: "center" }}>
                  ...
                  {cell && !isSlideTarget && (
                    <div
                      ...
                      style={{
                        width: cell.type === "pawn" ? "58%" : "84%",
                        marginBottom: cell.type === "pawn" ? "3%" : 0,
                        alignSelf: cell.type === "pawn" ? "flex-end" : "center",
                        filter: isSel
          ...
          {slideAnim && (
            ...
            >
              <div style={{
                width: slideAnim.piece.type === "pawn" ? "58%" : "84%",
                marginBottom: slideAnim.piece.type === "pawn" ? "3%" : 0,
                alignSelf: slideAnim.piece.type === "pawn" ? "flex-end" : "center",
              }}>
