...
// getoond in een vlak van hun eigen stukkleur net buiten die hoek van het
// bord — precies boven de vakjes waar hun pion ook start, zodat de
// koppeling kleur-naam zo direct mogelijk is.
export default function Board({ board, selected, slideAnim, interactive, onCellClick, highlight, labelTopLeft, labelBottomRight }) {
  return (
